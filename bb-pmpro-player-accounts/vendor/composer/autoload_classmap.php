...
return array(
    'BB_PMPro_Player_Accounts\\Admin\\Admin_Settings' => $baseDir . '/admin/class-admin-settings.php',
    'BB_PMPro_Player_Accounts\\BB_PMPro_Player_Accounts' => $baseDir . '/bb-pmpro-player-accounts.php',
    'BB_PMPro_Player_Accounts\\Includes\\Account_Adjuster' => $baseDir . '/includes/class-account-adjuster.php',
    'BB_PMPro_Player_Accounts\\Includes\\Checkout_Handler' => $baseDir . '/includes/class-checkout-handler.php',
    'BB_PMPro_Player_Accounts\\Includes\\Invoice_Customizer' => $baseDir . '/includes/class-invoice-customizer.php',
    'BB_PMPro_Player_Accounts\\Includes\\Membership_Level_Settings' => $baseDir . '/includes/class-membership-level-settings.php',
    'BB_PMPro_Player_Accounts\\Includes\\Player_Accounts_Manager' => $baseDir . '/includes/class-player-accounts-manager.php',
    'BB_PMPro_Player_Accounts\\Includes\\Proration_Handler' => $baseDir . '/includes/class-proration-handler.php',
    'BB_PMPro_Player_Accounts\\Includes\\Rest_API' => $baseDir . '/includes/class-rest-api.php',
    'BB_PMPro_Player_Accounts\\Traits\\Account_Calculations' => $baseDir . '/includes/traits/trait-account-calculations.php',
    'BB_PMPro_Player_Accounts\\Traits\\Stripe_Invoice_Helper' => $baseDir . '/includes/traits/trait-stripe-invoice-helper.php',
